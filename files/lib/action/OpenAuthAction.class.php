...
class OpenAuthAction extends AbstractAction
{
    ...
    public function execute()
    {
        ...
        if (isset($_REQUEST['code'])) {
            // check state
            if (empty($_REQUEST['state']) || null === WCF::getSession()->getVar('__openauthInit') || !hash_equals($_REQUEST['state'], WCF::getSession()->getVar('__openauthInit'))) {
                throw new IllegalLinkException();
            }
            ...
            if (empty($tokenInfo['access_token'])) {
                throw new NamedUserException(WCF::getLanguage()->get('wcf.user.3rdparty.openauth.connect.error.invalid'));
            }
            ...
            if (WCF::getUser()->userID) {
                ...
                if ($user->userID) {
                    ...
                    throw new NamedUserException(WCF::getLanguage()->getDynamicVariable('wcf.user.3rdparty.openauth.connect.error.inuse'));
                }
